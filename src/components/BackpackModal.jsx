    ...
    <ModalShell isOpen={isOpen} onClose={onClose} panelClassName="sm:max-w-2xl">
      <ModalHeader>
        <div className="flex items-start justify-between gap-3">
          ...
          <ModalCloseButton onClick={onClose} label="关闭背包" />
        </div>
      </ModalHeader>
                ...
                >
                  <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                    ...
                    <button
                      ...
                      className="inline-flex w-full items-center justify-center gap-1 rounded-xl border border-violet-200 bg-violet-50 px-3 py-2 text-sm font-medium text-violet-700 transition hover:border-violet-300 hover:bg-violet-100 disabled:cursor-not-allowed disabled:border-slate-200 disabled:bg-slate-100 disabled:text-slate-400 md:w-auto"
                    >
                      <Wrench size={14} />
                      二手卖出 ${resale}
                    </button>
