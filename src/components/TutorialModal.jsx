...
function TutorialModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/55 px-4 backdrop-blur-sm">
      <div className="flex max-h-[90vh] w-full max-w-4xl flex-col rounded-3xl border border-sky-200 bg-white p-6 shadow-2xl sm:p-8">
        ...
        <div className="min-h-0 space-y-4 overflow-y-auto pr-1">
          ...
          <section className="rounded-2xl border border-rose-200 bg-rose-50 p-4">
            ...
            <p className="text-sm leading-relaxed text-slate-700">
              时刻关注【精力】和【精神】，跌破 20 将积累亚健康，一旦『生病+抑郁』将触发辞世结局。
            </p>
          </section>
          ...
          <section className="rounded-2xl border border-indigo-200 bg-indigo-50 p-4">
            ...
            <p className="text-sm leading-relaxed text-slate-700">
              手机里的内幕消息和天桥下的算卦道人，真假参半，请用你的【运气】和【智慧】去甄别。
            </p>
          </section>
          ...
          <section className="rounded-2xl border border-sky-200 bg-sky-50 p-4">
            ...
            <div className="grid gap-2 text-xs text-slate-700 sm:grid-cols-2">
              <p className="rounded-xl border border-sky-200 bg-white p-3">💰 资金：消费、炒股、投资都靠它，≤0 有破产风险。</p>
              <p className="rounded-xl border border-sky-200 bg-white p-3">⚡ 精力：太低会触发亚健康，归零直接出局。</p>
              <p className="rounded-xl border border-sky-200 bg-white p-3">🧠 精神：太低会抑郁/幻觉，归零直接出局。</p>
              <p className="rounded-xl border border-sky-200 bg-white p-3">❤️ 老板好感：影响职场事件走向和惩罚强度。</p>
              <p className="rounded-xl border border-sky-200 bg-white p-3">🤝 同事关系：影响甩锅、帮忙、八卦线索质量。</p>
              ...
              <p className="rounded-xl border border-sky-200 bg-white p-3">🍀 运气（隐藏）：每天暗中变化，影响股市和剧情后果。</p>
            </div>
          </section>
        ...
        <button
          ...
          className="mt-5 h-12 w-full rounded-2xl bg-sky-500 px-4 text-sm font-semibold text-white transition hover:bg-sky-400 disabled:cursor-not-allowed disabled:bg-slate-300"
        >
        ...
        <div className="mt-2 flex justify-end">
          <button
            ...
            className="text-[11px] text-slate-300 transition hover:text-amber-600"
          >
            dev +1000 魂
          </button>
        </div>
